...
>(({ className, size = "md", children, ...props }, ref) => {
  ...
  return (
    <DialogPortal>
      ...
      >
        {children}
        <DialogPrimitive.Close className="absolute right-4 top-4 rounded-sm opacity-70 cursor-pointer transition-opacity hover:opacity-100 focus:outline-none focus:ring-2 focus:ring-[var(--tenant-primary)] disabled:pointer-events-none text-[var(--text-secondary)]">
          <X className="h-4 w-4" />
