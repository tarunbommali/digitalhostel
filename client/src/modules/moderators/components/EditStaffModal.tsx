...
import { Loader2, Users, QrCode, Utensils, ShieldAlert, CheckCircle2 } from "lucide-react";
  ...
  return (
    <Dialog open={open} onOpenChange={onOpenChange}>
      <DialogContent className="max-w-xl">
        <DialogHeader>
          <DialogTitle>Edit Staff Account Details & Operational Privileges</DialogTitle>
        </DialogHeader>
