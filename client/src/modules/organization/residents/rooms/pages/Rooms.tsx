  ...
  return (
    <div className="space-y-6 animate-in fade-in duration-150">
      <PageHeader
        eyebrow="Facilities"
        title="Rooms & Beds"
        description="Manage hostel blocks, room capacities, and assign student bed allocations"
        breadcrumbs={[
      ...
      <div className="grid md:grid-cols-2 gap-6">
        <AddRoomCard
          ...
          setHostelBlock={setHostelBlock}
          roomNumber={roomNumber}
          setRoomNumber={setRoomNumber}
          capacity={capacity}
          setCapacity={setCapacity}
          busyRoom={busyRoom}
          blockGenderFilter={blockGenderFilter}
          blocks={blocks}
          addRoom={addRoom}
        />

        <AllocateBedCard
          allocRoomId={allocRoomId}
          setAllocRoomId={setAllocRoomId}
          allocStudent={allocStudent}
          setAllocStudent={setAllocStudent}
          pickedStudentId={pickedStudentId}
          setPickedStudentId={setPickedStudentId}
          bedNumber={bedNumber}
          ...
          rooms={rooms}
          blocks={blocks}
          studentSearchMatches={studentSearchMatches}
          allocate={allocate}
        />
      </div>
      ...
      <RoomsGridTable
        ...
        blocks={blocks}
        blockGenderFilter={blockGenderFilter}
        setBlockGenderFilter={setBlockGenderFilter}
      />
    </div>
  );
}
