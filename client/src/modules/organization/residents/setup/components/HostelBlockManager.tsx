...
import { GenderBadge } from "@/core/components/ui/GenderBadge";
...
export function HostelBlockManager({
  ...
  const isBlockLimitReached = safeBlocks.length >= maxBlocks;
    ...
    <Card className="p-6">
      <div className="flex items-center justify-between border-b pb-3 mb-4">
        <div className="flex items-center gap-2 font-semibold text-base">
          ...
          <span>Hostel Blocks ({safeBlocks.length}{maxBlocks !== Infinity ? `/${maxBlocks}` : ""})</span>
        </div>
        {isBlockLimitReached && (
